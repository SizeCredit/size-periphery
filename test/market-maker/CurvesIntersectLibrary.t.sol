...
contract CurvesIntersectionLibraryTest is Test {
    function assertEq(bool a, bool b, bool c) internal pure {
        assertEq(a, b);
        assertEq(b, c);
    }

    function test_CurvesIntersectionLibrary() public {
        ...
        assertEq(intersectSimple, intersects, true);
    }

    function test_CurvesIntersectionLibrary_curvesIntersect_normal_inverted() public {
        YieldCurve memory curve1 = YieldCurveHelper.normalCurve();
        YieldCurve memory curve2 = YieldCurveHelper.invertedCurve();
        VariablePoolBorrowRateParams memory variablePoolBorrowRateParams;
        bool intersectsSimple =
            CurvesIntersectionLibrarySimple.curvesIntersect(curve1, curve2, variablePoolBorrowRateParams, 0, 0);
        bool intersects = CurvesIntersectionLibrary.curvesIntersect(curve1, curve2, variablePoolBorrowRateParams);
        assertEq(intersectsSimple, intersects, true);
    }

    function test_CurvesIntersectionLibrary_curvesIntersect_normal_steep() public {
        ...
        assertEq(intersectsSimple, intersects, false);
    }

    function test_CurvesIntersectionLibrary_curvesIntersect_flat_inverted() public {
    ...
    function test_CurvesIntersectionLibrary_curvesIntersect_humped_negative() public {
    ...
    function testFailFuzz_CurvesIntersectionLibrary_curvesIntersect_pointCurve_fails(uint256 x, int256 y) public {
    ...
    function testFuzz_CurvesIntersectionLibrary_curvesIntersect(
        ...
        VariablePoolBorrowRateParams memory variablePoolBorrowRateParams;
        bool intersectsSimple = CurvesIntersectionLibrarySimple.curvesIntersect(
    ...
    function testFail_CurvesIntersectionLibrary_curvesIntersect_concrete_fails() public {
        uint256 x1 = 1469;
        uint256 y1 = 4662;
        uint256 x2 = 2891;
        ...
        uint256 Y2 = 1053;
        testFuzz_CurvesIntersectionLibrary_curvesIntersect(x1, y1, x2, y2, X1, Y1, X2, Y2, 0);
    }

    function test_CurvesIntersectionLibrary_curvesIntersect_concrete_succeeds_1_pct_tolerance() public {
        uint256 x1 = 1469;
        uint256 y1 = 4662;
        uint256 x2 = 2891;
        uint256 y2 = 90089598632592328463;
        ...
        uint256 X2 = 315359080;
        uint256 Y2 = 1053;
        testFuzz_CurvesIntersectionLibrary_curvesIntersect(x1, y1, x2, y2, X1, Y1, X2, Y2, PERCENT / 100);
    }

    function testFail_CurvesIntersectionLibrary_curvesIntersect_concrete_fails_001_pct_tolerance() public {
        ...
        testFuzz_CurvesIntersectionLibrary_curvesIntersect(x1, y1, x2, y2, X1, Y1, X2, Y2, PERCENT / 1e4);
    }

    function testFail_CurvesIntersectionLibrary_curvesIntersect_concrete_fails_1_pct_tolerance() public {
        uint256 x1 = 315359999;
        uint256 y1 = 1178651033205;
        uint256 x2 = 315360000;
        uint256 y2 = 3991797;
    ...
    function testFail_CurvesIntersectionLibrary_curvesIntersect_concrete_fails_005_pct_tolerance() public {
        uint256 x1 = 315359999;
        uint256 y1 = 1178651033205;
        uint256 x2 = 315360000;
        uint256 y2 = 3991797;
        ...
        testFuzz_CurvesIntersectionLibrary_curvesIntersect(x1, y1, x2, y2, X1, Y1, X2, Y2, tolerance);
    }
}
